# 📜 Licencias y Directrices de DDLC
...
## 🎨 Obras de fans
"Obra de fans" se refiere a cualquier contenido que incluya Propiedad Intelectual perteneciente a Team Salvato. El contenido en cuestión incluye, pero no se limita a, arte, música, animación, escritura, videos, sitios web, aplicaciones y juegos. Las directrices se aplican a cualquier obra de fans que tenga lugar en el universo de DDLC o que incluya personajes, escenarios o la historia de DDLC. 🖌️

No hay restricciones sobre cómo los artistas eligen representar a los personajes, escenarios o eventos de DDLC en sus obras de fans. Valoramos la libertad artística y no tomaremos medidas contra una obra de fans únicamente porque no estemos de acuerdo con su contenido o porque entre en conflicto con representaciones oficiales.
...
Las obras de fans deben estar relacionadas de alguna manera con el universo de DDLC; no puedes usar Propiedad Intelectual de Team Salvato para proyectos que no se consideren derivados de DDLC (por ejemplo, usar un personaje de DDLC para representar un sitio web o producto que no sea un derivado de DDLC). 🚫

Las empresas o compañías interesadas en producir obras de fans de DDLC para la venta por cualquier medio que no sea el descrito anteriormente deben contactarnos para obtener una licencia o permiso. 📞

### 🖼️ Obras de fans que incluyen activos oficiales de DDLC
Algunos artistas eligen incluir activos creados por Team Salvato en sus obras de fans. Estos activos incluyen, pero no se limitan a, cualquier arte, música, escritura o código que haya sido incluido en el juego DDLC o en material de marketing/promoción relacionado con DDLC.

Ejemplos de obras de fans en esta categoría incluyen juegos, sitios web, videos o música que contengan activos de DDLC.  
...
🚫 **Está prohibido subir o alojar directamente activos de DDLC**, salvo que formen parte de una obra de fans. Tampoco se puede obtener beneficio alguno de estas subidas.  
...
💖 **Gracias por tomarte el tiempo de leer estas directrices.** No buscamos restringir la creatividad de los artistas, sino permitirles crear contenido inspirado en DDLC de manera respetuosa. Valoramos la libertad artística y nos encanta ver cómo los fans disfrutan DDLC de diferentes maneras. 🎨🎶

## 🌟 Directrices Específicas para *Monika After Story*  

En general, somos muy abiertos a que los activos y el código de *Monika After Story* sean utilizados en otros proyectos. Sin embargo, existen algunas restricciones.  

🚫 **No está permitido utilizar los activos o el código de *Monika After Story* para crear un mod o fork que funcione como reemplazo de *Monika After Story***. Si deseas agregar nuevas funciones o contenido al juego, te animamos a contribuir al proyecto original. Somos muy receptivos a sugerencias y contribuciones, por lo que es probable que cualquier mejora sea bienvenida.  

📌 Si por alguna razón tus nuevas funciones entran en conflicto con la dirección de *Monika After Story*, considera desarrollar tus cambios en forma de un **submod**, que pueda añadirse al juego sin reemplazarlo.  

🔗 **Sigue las [Directrices de Propiedad Intelectual de Team Salvato](http://teamsalvato.com/ip-guidelines/)** para cualquier proyecto que incluya nuestro trabajo.  

💖 **Dale crédito a *Monika After Story*** por cualquier recurso que utilices y enlaza de vuelta a nuestro proyecto en [http://www.monikaafterstory.com/](http://www.monikaafterstory.com/). No reclames como propio el trabajo de otras personas y, cuando sea necesario, acredita individualmente a los creadores de los recursos, como los assets de arte utilizados.  
...
🔹 **Las pistas de música y sonidos libres de regalías utilizados en *Monika After Story* están exentos de estas restricciones.**  
...
❌ **El código de *Monika After Story* no puede ser distribuido o utilizado fuera del proyecto sin el consentimiento expreso del equipo de *Monika After Story*.**  
...
✔️ No obtengamos ganancias con ello.  
✔️ No lo promocionemos como una alternativa a DDLC.  
✔️ No lo distribuyamos como un juego independiente.  
